        ...
        <div className="relative lg:w-[700px] lg:h-[700px] w-[350px] h-[300px] rounded-2xl bg-transparent">
          <div className="absolute lg:block hidden w-[700px] h-[700px] -z-0 rounded-2xl bg-transparent">
            <img
              src={cewe}
              alt="svg ku"
              className=" hidden lg:block absolute bottom-0 -right-80 translate-x-11"
            />
            <img
              src={cowo}
              alt="svg ku"
              className=" hidden lg:block absolute bottom-0 -left-80 -translate-x-3"
            />
          </div>
          <div className="absolute lg:hidden block h-[500px] w-[340px] -z-0 rounded-2xl bg-transparent">
            <img
              src={wedok}
              alt="svg ku"
              className="absolute lg:hidden h-[180px] -top-[137px] -right-[30px] -translate-y-10 -rotate-3"
            />
            <img
              src={lanang}
              alt="svg ku"
              className="absolute lg:hidden h-44 -top-[70px] rotate-3 -left-4 -translate-y-24"
            />
          </div>
          <div className="relative form-wrapper lg:w-[700px] lg:h-[700px] w-[340px] h-[500px] flex flex-col justify-start items-center rounded-2xl bg-white">
            <h1 className="text-3xl lg:text-slate-700 lg:text-4xl font-semibold translate-x-5 lg:mt-24 mt-14">
              Selamat Datang!👋
            </h1>
            <p className="font-semibold text-slate-700 text-sm lg:text-base mt-3">
              Masuk dan mulai langkahmu.
            </p>

            <form
              onSubmit={handleSubmit}
              className="lg:mt-24 mt-8 flex flex-col w-[80%]"
            >
              <div className="input-box lg:mx-7">
                <p className="font-poppins font-medium text-slate-700 lg:text-[18px] text-[16px] mb-1">
                  Email
                </p>
                <input
                  className="bg-[#f6f6f6] border-lg border-[#efefef] outline-none rounded-lg px-5 lg:h-14 h-12 w-full"
            ...
            <div className="login-footer font-semibold mt-8 lg:mt-9">
              <p className="text-slate-700 text-sm lg:text-base">
                ...
                <span className="text-[#2D8EFF] ">
                  <a href="https://www.instagram.com/raphael.eskalaber/?utm_source=ig_web_button_share_sheet">
                    Raphael
                  </a>
                </span>
              </p>
