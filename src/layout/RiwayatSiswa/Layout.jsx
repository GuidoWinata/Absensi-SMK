...
export default function Layout() {
    const { selectedDate } = useContext(TanggalContext);

    const todos = {
        '2024-07-03': ['Todo 1', 'Todo 2', 'Todo 3'],
    ...
    return (
        <Box sx={{ height: '100vh' }}>
            ...
            <Grid container spacing={0} sx={{ height: '99%' }}>
                <Grid item xs={8} sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', paddingRight: 2 }}>
                    <AnimatedCardBox sx={{ height: '35%', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingBottom: '3px', width: '99%', border: '1px', borderRadius: 2, boxShadow: '2px 4px 8px rgba(0.5, 0.1, 0.1, 0.1)', margin: '2px' }}>
                        <Card />
                    </AnimatedCardBox>
                    <AnimatedTableBox sx={{ height: '50.5%', display: 'flex', alignItems: 'center', flexDirection: 'column', paddingTop: '120px', width: '99%', border: '1px', borderRadius: 2, boxShadow: '2px 4px 8px rgba(0.5, 0.1, 0.1, 0.1)', margin: '2px' }}>
                        <Box sx={{ height: '70%', display: 'flex', width: '95%', border: '1px', borderRadius: 2, boxShadow: '2px 4px 8px rgba(0.5, 0.1, 0.1, 0.1)' }}>
                            <TableRiwayat />
                        </Box>
                    </AnimatedTableBox>
                </Grid>
