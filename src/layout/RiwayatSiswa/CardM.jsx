      ...
      <Box sx={{ marginLeft: 0, display: 'flex', flexDirection: 'row', textAlign: 'start', height: '65%', alignItems: 'center' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent:'space-between' }}>
          <Box sx={{ textAlign:'center' }}>
            <Typography variant="caption" fontSize={20} sx={{ bgcolor:'#2D8EFF', px: 10, pt: 2, pb: 0.5, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', whiteSpace: 'nowrap' }} fontWeight="semibold" color="#ffff">
            Total ijin
            </Typography>
            <Typography variant="h5" color="#0175f8" sx={{ fontWeight: 'bold', fontSize: 60, py: 1 }}>
            {izinCount}
            </Typography>
            <Typography variant="subtitle2" fontSize={20} fontWeight="semibold" color="#2D8EFF">
              Hari
            </Typography>
          </Box>
        </Box>
  ...
  <Grid item xs={6} sm={6} md={3}>
              ...
              <Box sx={{ marginLeft: 0, display: 'flex', flexDirection: 'row', textAlign: 'start', height: '65%', alignItems: 'center' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                  <Box sx={{ textAlign:'center' }}>
                    <Typography variant="caption" fontSize={20} sx={{ bgcolor:'#00D8B6', px: 10, pt: 2, pb: 0.5, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', whiteSpace: 'nowrap' }} fontWeight="semibold" color="#ffff">
                    Total Sakit
                    </Typography>
                    <Typography variant="h5" color="#0175f8" sx={{ fontWeight: 'bold', fontSize: 60, py: 1 }}>
                    {sakitCount}
  ...
  <Grid item xs={6}>
              ...
              <Box sx={{ marginLeft: 0, display: 'flex', flexDirection: 'row', textAlign: 'start', height: '65%', alignItems: 'center' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                  <Box sx={{ textAlign:'center' }}>
                    <Typography variant="caption" fontSize={18} sx={{ bgcolor:'#FFAE1F', px: 10, pt: 2, pb: 0.5, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', whiteSpace: 'nowrap' }} fontWeight="semibold" color="#ffff">
                    Total Alpha
                    </Typography>
                    <Typography variant="h5" color="#0175f8" sx={{ fontWeight: 'bold', fontSize: 60, py:1 }}>
                    {alphaCount}
